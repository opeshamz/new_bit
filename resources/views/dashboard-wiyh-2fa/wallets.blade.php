...
<div class="page-content">
    <div class="container">
        ...
        @section('script')
        <script>
            Notiflix.Report.Success('Success', '{{ session('
                success ') }}', 'Ok');
            // setTimeout(function (){
            //    location.reload();
            // }, 4000);
        ...
        <script>
            ...
            Notiflix.Notify.Failure('{{ session('
                error ') }}');
        </script>
        @endsection
        @endif
                    ...
                    <div class="card-innr" style="margin: auto;">
                        <div class="token-balance token-balance-with-icon">
                            ...
                            <div class="token-balance-text">
                                <h6 class="card-sub-title"><img src="{{asset('images/naira.svg')}}"> &nbsp; Naira Wallet</h6><br><span class="lead"><em class="ti ti-wallet"> </em> {{number_format($naira_wallet->balance, 2)}} <b>₦</b> <br> <br><a href="{{url('dashboard/naira_wallet')}}" class="btn btn-outline btn-secondary" style=" color: white; border-color: white;">View more</a> <img src="{{asset('images/naira.png')}}" width="100px" height="auto">
                                </span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-innr">
                                ...
                                <div class="form-check-inline">
                                    <p style="margin-bottom: 30px;"><img src="{{asset('images/naira.svg')}}"> &nbsp; Naira Wallet &nbsp;
                                        <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked style="margin: 5px 5px;">
                                    </p>
                                ...
                                <div class="form-check-inline">
                                    <p><img src="{{asset('images/btc.svg')}}"> &nbsp; Btc Wallet &nbsp;
                                        <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" style="margin: 5px 5px;">
                                    </p>
            ...
            <div class="col-xl-5 col-lg-5">
                <div class="token-calculator card">
                    <div class="nomics-ticker-widget-embedded nomics-ticker-widget-size-responsive nomics-ticker-widget-bg-light">
                        <iframe frameborder="0" scrolling="yes" height="270px" sandbox="allow-same-origin allow-scripts allow-top-navigation allow-popups" src="https://widget.nomics.com/assets/BTC/USD/"></iframe>
                        <div class="nomics-ticker-widget-footer" style="display: none !important; visibility: visible !important; opacity: 1 !important;"></div>
                    </div>
