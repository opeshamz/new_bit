...
<li class="topbar-nav-item relative">
    <span class="user-welcome d-none d-lg-inline-block">{{Auth::user()->firstname}} {{Auth::user()->lastname}} </span>
            ...
            <div class="user-status">
               ...
               <br>
                ...
                {{-- <li><a href="{{route('dashboard.profile', Auth::user()->id)}}"><i class="ti ti-id-badge"></i>My Profile</a></li> --}}
                    ...
                    <li><a href="{{ route('dashboard.account') }}"><i class="ti ti-settings"></i>Settings</a></li>
