    ...
    <div class="content-area card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <input class="input-bordered" type="text" id="full-name" name="firstname" value="{{$user->firstname}}" readonly required>
                                </div>
                                <!-- .input-item -->
                            </div>
                            <div class="col-md-6">
                                ...
                                <input class="input-bordered" type="text" id="email-address" name="lastname" value="{{$user->lastname}}" readonly required>
                                </div>
                                <!-- .input-item -->
                            </div>
                            <div class="col-md-6">
                                <div class="input-item input-with-label">
                                    ...
                                    <input class="input-bordered" name="email" type="email" name="" id="mobile-number" value="{{$user->email}}">
                                </div>
                                <!-- .input-item -->
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- .input-item -->
                                 <script> 
        function My_Date() { 
            document.getElementById("date-of-birth").readOnly = true; 
        } 
        ...
        My_Date();
                            ...
                            <strong>Referral Link</strong>
                                ...
                                <div class="input-group-prepend">
                                      ...
                                      <input type="text" class="form-control input-bordered" value="{{ Auth::user()->referral_link }}" id="myInput" readonly>
                                        <button type="button" class="input-group-t test btn-primary" data-clipboard-target="#myInput">copy link</button>
                                    </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="password">
                            ...
                            <div class="col-md-12 secs">
                                ...
                                <button type="button" id="pass" class="btn btn-info" data-toggle="modal" data-target="#exampleModal">Click Here</button>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 secs">
                                ...
                                <button type="button" id="pin" class="btn btn-info" data-toggle="modal" data-target="#exampleModal1">Set Pin</button>
                                @else
                                <h3>Reset Pin</h3>
                                <p>Forgot your 4 digit pin? You can reset it now!</p>
                                <button type="button" id="pin" class="btn btn-info" data-toggle="modal" data-target="#exampleModal2">Reset Pin</button>
                                @endif
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 secs">
                                ...
                                <p>2 Factor Authentication is a multi-layer security measure to ensure the safety of your account</p>
                                @if($user->loginSecurity != null && $user->loginSecurity->google2fa_enable)
                                <div class="alert alert-success">
                                    2FA is currently <strong>enabled</strong> on your account.
                                </div>
                                @else
                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal12">Enable</button>
                                @endif
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12 secs">
                                ...
                                <button type="button" id="del" class="btn btn-info">Delete Account</button>
                                  </div>
                                </div>
                              </div>
        ...
        <div class="input-item input-with-label">
            ...
            <option value="057-Zenith Bank">Zenith Bank</option>
                                    ...
                                    <!-- 10px gap -->
                                    <div class="d-sm-flex justify-content-between align-items-center">
                                        <button class="btn btn-info" id="pa1">Submit</button>
                                        <div class="gaps-2x d-sm-none"></div>
                                  </div>
                                </form>
                                </div>
                                ...
                                <div class="tab-pane fade" id="verify">
                                    ...
                                    <div class="col-md-12 secs2">
                                        ...
                                        <p>Account Upgraded to Level 1</p>
                                         @else
                                        <p>Upgrade your account to level 1 by updating your BVN and increase your transaction limit to 	&#8358;50,000,000.00</p>
                                        @endif

                                        @if($user->account->holder_name == null)
                                        <button type="button" id="no_bank_details" class="btn btn-info pull-right">Update BVN</button>
                                        @else
                                        @if($user->bvn_verified != 1 && $user->stage_id != 2)
                                        <button type="button" class="btn btn-info pull-right" data-toggle="modal" data-target="#exampleModal3">Update BVN</button>
                                        @endif
                                        @endif
                                    </div>
                                        </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  {{--modal for 2factor Authentication--}}
          ...
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form>
                    ...
                    <div class="col-md-12"><br>
                        ...
                        <i class="fas fa-user-shield text-info fa-5x"></i><br><br>
                        </div>

                    <h2 class="text-center"><strong>Please, set up 2-factor authentication to proceed.</strong></h2>
                    <p>2 factor authentication is an additional security layer for user identity confirmation and this is required for all transactions.</p>
                    <p>To set up two-factor authentication, Please click “Get Started” below and follow the instructions carefully.</p>
                    <div class="col-md-8 offset-4">
                    <button type="button" data-toggle="modal" data-target="#exampleModal13" class="btn btn-info">Get Started</button>
                    </div>
                </div>
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            {{-- <form>
                    ...
                    <div class="col-md-12"><br>
                        {{-- <div class="col-md-8 offset-4"> --}}
                            <h1 class="text-center"><strong>2-Factor Authentication</strong></h1><br>
                        {{-- </div> --}}


                    <h5>We strongly recommend you to enable 2FA on your account.</h5>
                    <p>A. 2-factor Authentication is an additional security layer for user authentication and Identity confirmation. It is highly recommended but optional.</p><br>
                    <p>B. Enabling 2-factor authentication involves you downloading the Google authenticator app on your mobile device (Android or Iphone), scanning a QR code generated using the app, and then using the Google Authenticator code every time you want to login, thereby verifying your account ownership.</p><br>
                    <p>C. To set up 2 factor authentication, Please click next and follow the instructions carefully.</p>
                    <div class="col-md-8 offset-4">
                        {{-- <form class="form-horizontal" method="POST" action="{{ route('generateSecret') }}">
                            @csrf --}}
...
$(document).on('click', '#start', function(){
     window.location = "{{route('get_auth')}}";
  })
});
</script>
@endsection
