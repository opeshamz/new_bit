...
<div class="page-content">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="token-statistics card card-token height-auto bb">
                ...
                <div class="page-content">
                    <div class="container">
                            <div class="col-lg-12 " style="margin-right:10px;">
                                <div class="content-area card shadow-sm p-3 mb-5 bg-white rounded nn">
                                    <div class="card-innr">
...
@media only screen and (min-width: 900px) {
  ...
  .nn{
      width: 550px;
                    ...
                    <div class="col-xl-5 col-lg-5 nk">
                    <div class="token-calculator card nn">
