                            ...
                            <div class="col-md-12 secs">
                              ...
                              <div class="col-md-12 secs">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-info dis">Disable Google 2FA</button>
...
$(document).on('click', '.dis', function(){
    ...
    $("#exampleModald").modal({show:true});

     $(".modal-header").html(`
     <h4 class="modal-title" id="exampleModalLabel">Please Enter Your Password to Disable Google 2FA</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
     `);
     ...
     <form action="{{route('disable2fa')}}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="input-item input-with-label">
                        <label class="input-item-label">Enter Password</label>
                        <input class="input-bordered" type="password" name="current-password" required>
                    </div>
