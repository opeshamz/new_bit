...
@endphp
            ...
            <div class="payment-card bg-info" style="border-radius: 10px;  color: white;">
              ...
              <div class="row">
                ...
                @if($card->is_active == true)
                 ...
                 <h4 class="text-center">Card Activated</h4>
                 @else
                 <!--<button type="button" class="btn btn-danger btn-sm">Card Deactivated</button><br><br>-->
                 <h4 class="text-center" style="color:red;">Card Deactivated</h4>
                 @endif
         </div>
        <div class="col-md-7">
   ...
   <div class="row">
                <div class="col-md-1">
                   <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn-success btn-sm">Fund</button>
                </div>
                <div class="col-md-1">
                ...
                <div class="col-md-1">
                @if($card->is_active == true)
                 <button type="button" id="block" class="btn-warning btn-sm bcard">Block</button>
                 @else
                 <button type="button" id="block" class="btn-success btn-sm bcard">Unblock</button>
                 @endif
                </div>
                ...
                <div class="col-md-1">
                @if($card->is_active == true)
                 <button type="button" id="terminate" class="btn-danger btn-sm">Terminate</button><br><br>
                 @endif
                </div>
        </div>
...
$(document).ready(function(){
    ...
    $('.setpin').keyup(function () {
     ...
     var card_id = $('#card_id').val();
     alert('Done and working ok. Need to verify if the card balance would reflect back to the payment dashboard');
//      Notiflix.Loading.Dots('Processing...');
//         Notiflix.Loading.Remove(3000);
//         axios.post("{{ url('/terminate_card') }}/"+card_id).then(data =>{
//         if(data.data.status == "success"){
//             Notiflix.Report.Success( 'Success', data.data.message, 'Ok' );
//             setTimeout(function (){
//             location.reload();
